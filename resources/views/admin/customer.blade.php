...
<div class="content">
            <div class="container-fluid">
                <div class="row">
                            ...
                            <p class="pull-left">Hiện tại có {{count($list_customer)}} khách hàng</p>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      <td style ="width: 20px; border-right: 1px ridge;">{{$i=$i+1}}</td>
                                        <td style ="width: 120px; border-right: 1px ridge;">{{$customer->name}}</td>
                                        <td style ="width: 150px ;   border-right: 1px ridge;">{{$customer->gender}}</td>
                                        <td style ="width: 60px ;   border-right: 1px ridge;">{{$customer->email}}</td>
                                        <td style ="width: 60px;    border-right: 1px ridge;">{{$customer->address}}</td>
                                        <td style ="width: 120px;    border-right: 1px ridge;">{{$customer->phone_number}}</td>
                                        <td style ="width: 80px;    border-right: 1px ridge;">{{$customer->note}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
