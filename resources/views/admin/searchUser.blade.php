      ...
      <div class="container">
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="{{route('member_list')}}">Thành viên</a> / <span>Tìm thành viên</span>
				</div>
			</div>
...
<div class="content">
            <div class="container-fluid">
                <div class="row">
                            ...
                            <p class="pull-left">Hiện tại có {{count($data)}} thành viên</p>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      <td style ="width: 20px; border-right: 1px ridge;">{{$i=$i+1}}</td>
                                        ...
                                        <td style ="width: 150px ;   border-right: 1px ridge;">{{$dt->email}}</td>
                                        <td style ="width: 60px ;   border-right: 1px ridge;">{{$dt->password}}</td>
                                        <td style ="width: 60px;    border-right: 1px ridge;">{{$dt->phone}}</td>
                                        <td style ="width: 120px;    border-right: 1px ridge;">{{$dt->address}}</td>
                                        <td style ="width: 80px;    border-right: 1px ridge;">{{$dt->role}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
